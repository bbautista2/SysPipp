                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group" style="margin-top: 15px;" id="divStock" runat="server">
                                ...
                                <div class="col-md-9 col-sm-9 col-lg-9">
                                    <button type="button" style="background-color: #5cb85c; border-color: #4cae4c;" class="btn btn-success" data-toggle="modal" data-target="#modalIngreso">Registrar Ingreso</button>
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalSalida">Registrar Salida</button>
                                </div>
                            </div>
